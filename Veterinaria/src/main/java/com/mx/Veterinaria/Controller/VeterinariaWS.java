...
public class VeterinariaWS {
	...
	//METODO QUE CONSUME LOS MICROSERVICIOS
		...
		//endpoint de Mascotas
			...
			public ResponseEntity<Responsables> guardarResponsables(@PathVariable("veterinariaId") int veterinariaId,@RequestBody Responsables responsables){
			...
			public ResponseEntity<Mascotas> guardarMascotas(@PathVariable("veterinariaId") int veterinariaId,@RequestBody Mascotas mascotas){
