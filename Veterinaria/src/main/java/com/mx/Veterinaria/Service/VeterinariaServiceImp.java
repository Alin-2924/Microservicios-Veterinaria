...
public class VeterinariaServiceImp implements IVeterinariaService{
	...
	public List<Responsables> obtenerResponsables(int veterinariaId){
		...
		List<Responsables> responsables = restTemplate.getForObject("http://localhost:8082/R/buscarPorVeterinaria/" + veterinariaId, List.class);
		return responsables;
	}
	...
	public List<Mascotas> obtenerMascotas(int veterinariaId){
		@SuppressWarnings("unchecked")
		List<Mascotas> mascotas = restTemplate.getForObject("http://localhost:8083/M/buscarPorVeterinaria/" + veterinariaId, List.class);
		return mascotas;
	}
